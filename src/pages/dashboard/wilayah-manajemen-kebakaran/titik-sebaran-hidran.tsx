...
import data from "@/data/Titik_Sebaran_Hidran_Basah.json";
...
export default function SebaranHidran() {
  ...
  return (
    <Layout>
      <main className="h-[80vh] max-h-[800px] relative">
        <h1 className="text-xl sm:text-2xl font-bold mb-5">Titik Sebaran Hidran Basah</h1>
        <Map
          markers={markers}
        />
      </main>
